# Microservices Architecture for Phonebook Web Application (Python Flask) with MySQL using Kubernetes.
...
- Step 1: Download or clone project definition from Github
